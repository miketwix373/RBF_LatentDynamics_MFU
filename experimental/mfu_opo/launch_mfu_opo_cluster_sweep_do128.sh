...
# at d_o=128 (95% fluctuation energy). Self-contained: precomputes
# coords_do128.npz from the frozen svd_basis.npz if absent, then runs the
...
#
# Usage
#     sbatch scripts/launch_mfu_opo_cluster_sweep_do128.sh
